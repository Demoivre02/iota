...
export const HeroView = () => {
  return (
	<div className='flex flex-col-reverse mx-4 my-8 hero-section lg:mx-24 md:flex-row lg:flex-row relative '>
	  <div className='flex flex-col gap-4 text-center md:text-start md:w-1/2 lg:gap-7 md:items-start md:justify-center'>
	  <Link  to={"/emergency"}>	  
		...
		<div className='flex'>
			...
			<a href='tel:+234-199' className='flex items-center gap-[2px] ml-[12px] text-[green] '>
		...
		<p className=''>Welcome to DavsHealth</p>
		<p className='text-[#10217D] text-3xl md:text-2xl lg:text-4xl leading-[44px] capitalize font-bold'>where you can easily book doctors, hospitals, and find the nearest pharmacy!</p>
		<p>Our platform allows you to search for doctors and hospitals based on specialty, location, and availability.</p>
