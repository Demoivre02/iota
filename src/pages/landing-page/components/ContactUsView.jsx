...
export const ContactUsView = () => {
  return (
	<div className='flex flex-col items-center mx-5 text-center bg-white md:mx-24 lg:my-16 '>
	  <h2 className='font-bold text-4xl text-[#282938]'>Contact us</h2>
	  <p className='text-[#00008B] font-normal text-lg mt-6 mb-8 md:mb-16'>Let us know what you will like to tell us</p>
	  <form action="">
