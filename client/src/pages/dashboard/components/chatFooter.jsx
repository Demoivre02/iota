...
export function ChatFooter({room}) {
  ...
  const sendMessage = () => {
    const message = {message: inputValue, room: room.id}
  ...
  return (
    <div className="flex gap-[15px] px-[18px] py-[12px] bg-[#fff] justify-between items-center items-end">
      ...
      <div className="w-[30px] h-[30px] rounded-full bg-[#fff] hover:bg-[#DFFBFD] flex justify-center items-center">
        ...
        <div onClick={sendMessage} style={{display: inputValue != '' ? "block" : "none"}}  className="w-[30px] h-[30px] rounded-full bg-[#fff] hover:bg-[#DFFBFD] flex justify-center items-center">
