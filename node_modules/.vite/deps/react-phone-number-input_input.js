...
function usePhoneDigits(_ref) {
  ...
  function getValueForPhoneDigits(phoneDigits2) {
    ...
    if (country && international && !withCountryCallingCode) {
      phoneDigits2 = "+".concat(getCountryCallingCode(country, metadata)).concat(phoneDigits2);
    }
...
function getPhoneDigitsForValue(value, country, international, withCountryCallingCode, defaultCountry, useNationalFormatForDefaultCountryValue, metadata, onCountryMismatch) {
  ...
  var asYouType = new AsYouType(void 0, metadata);
...
function PhoneInput(_ref, ref) {
  ...
  var _usePhoneDigits = usePhoneDigits({
    ...
    metadata
  }), _usePhoneDigits2 = _slicedToArray2(_usePhoneDigits, 2), phoneDigits = _usePhoneDigits2[0], setPhoneDigits = _usePhoneDigits2[1];
...
PhoneInput.propTypes = {
   ...
   */
  useNationalFormatForDefaultCountryValue: import_prop_types.default.bool.isRequired,
  /**
   * `libphonenumber-js` metadata.
   */
  metadata: import_prop_types.default.object.isRequired
};
...
function createInput(defaultMetadata) {
  function PhoneInput2(_ref, ref) {
    var smartCaret = _ref.smartCaret, rest = _objectWithoutProperties2(_ref, _excluded2);
  ...
  PhoneInput2.propTypes = {
     ...
     */
    // Is `true` by default.
    smartCaret: import_prop_types2.default.bool.isRequired,
    /**
     * `libphonenumber-js` metadata.
     */
